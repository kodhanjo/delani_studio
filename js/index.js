$(document).ready(function () {
  ...
  const submitForm = (event) => {
    ...
    const url =
      "https://gmail.us17.list-manage.com/subscribe/post?u=ce559dfbfea8ab2302f8236cb&amp;id=4c3e72b3cb";
    ...
    alert(
      `Hey ${FNAME}, we have received your message. Thank you for reaching out to us.`
    );
  };
